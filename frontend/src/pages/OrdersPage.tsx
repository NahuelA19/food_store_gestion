      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full h-10 pl-9 pr-8 rounded-xl border border-border bg-white dark:bg-surface-card text-sm text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all"
          />
          {inputValue && (
            <button
